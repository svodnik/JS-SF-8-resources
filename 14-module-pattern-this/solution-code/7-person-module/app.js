...
sarah.celebrateBirthday();

console.log(sarah.getAge()) // 33

console.log(sarah.getKids()) // []

sarah.haveAKid('judah');

console.log(sarah.getKids()) // ['judah']