...
// Copy the entire object above (including the opening and closing braces {...}, but NOT 'let notActuallyJSON =' or the trailing semicolon).
...
// (Remember that the object is only the content between the braces, including the braces themselves.)
...
// [ Step 5 ] Go to http://jsonlint.com/  and create a custom JSON string, and save it below as a variable.
// Use JavaScript methods to convert the string to a JavaScript object, then to convert that object back to JSON.
// Compare the final result to the JSON string you originally created - how has it changed?
